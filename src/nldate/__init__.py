...
def parse(s: str, today: date | None = None) -> date:
    ...
    # 1. Handle Holidays manually (since dateparser is inconsistent here)
    ...
    # We use a non-greedy match for the offset to handle "1 year and 2 months after yesterday"
    ...
    if match:
        ...
        # Calculate offset delta using a fixed reference
        ref = datetime(2000, 1, 1)
        offset_dt = dateparser.parse(f"{offset_str} ago", settings={"RELATIVE_BASE": ref})
